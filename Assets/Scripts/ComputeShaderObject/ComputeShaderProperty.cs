...
{
    public enum ComputeShaderPropertyType
    {
        Int,
        Float,
        Vector3,
    ...
    public abstract class ComputeShaderProperty
    {
        ...
        public ComputeShaderProperty(string name) => this.name = name;
    ...
    class ComputeShaderIntProperty : ComputeShaderProperty
    {
        public int Value;
    ...
    class ComputeShaderFloatProperty : ComputeShaderProperty
    {
        public float Value;
    ...
    class ComputeShaderVector3Property : ComputeShaderProperty
    {
    ...
    class ComputeShaderVector4Property : ComputeShaderProperty
    {
